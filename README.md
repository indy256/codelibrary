...
+ [x] Suffix tree Ukkonen's algorithm [**java**](java/strings/SuffixTree.java) [**cpp**](cpp/strings/suffix_tree_ukkonen.cpp)
+ [x] Suffix tree Breslauer-Italiano simple algorithm [**cpp**](cpp/strings/suffix_tree_breslauer_italiano.cpp)
