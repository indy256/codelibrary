...
+ [x] Suffix tree [**java (Ukkonen's algorithm)**](java/strings/SuffixTree.java) [**cpp (Breslauer-Italiano simple algorithm)**](cpp/strings/suffix_tree_breslauer_italiano.cpp)
